...
CREATE TABLE `resultdetails` (
  ...
  `results_details_id` varchar(255) DEFAULT NULL,
  `results_id` varchar(255) DEFAULT NULL,
  `risk_score` float DEFAULT NULL,
  `sample_id` varchar(255) DEFAULT NULL,
  `uid` varchar(255) DEFAULT NULL,
  KEY `sample_id_idx3` (`sample_id`),
  CONSTRAINT `sample_id3` FOREIGN KEY (`sample_id`) REFERENCES `samples` (`sample_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `results` (
  ...
  KEY `sample_id_idx2` (`sample_id`),
  CONSTRAINT `sample_id2` FOREIGN KEY (`sample_id`) REFERENCES `samples` (`sample_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-02-28 16:03:18
